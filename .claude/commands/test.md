...
- effects.test.js (123 tests) — calculateEffects, checkWinCondition, getCongestSurcharge, calculateRoadWideningBonus, weather multipliers
- balance.test.js (45 tests) — balance simulations
...
Total: 389 Vitest tests. If any tests fail, show the failure messages and stop — do not proceed with any further work until the failures are fixed.
